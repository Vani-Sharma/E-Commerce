        ...
        <div className="pt-6">
          ...
          <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
            <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
              <h1 className="text-2xl flex justify-start font-bold tracking-tight text-gray-900 sm:text-3xl">
                {product.title}
              </h1>
            </div>
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div className="mt-10">
                <h3 className="text-sm font-medium flex justify-start text-gray-900">
                  Highlights
                </h3>
                  ...
                  <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                    {highlights.map((highlight) => (
                      <li key={highlight} className="text-gray-400 ">
                        <span className="text-gray-600 flex justify-start">
                          {highlight}
                        </span>
                      </li>
                    ))}
              ...
              <div className="mt-10">
                <h2 className="text-sm font-medium flex justify-start text-gray-900">
                  Details
                </h2>
